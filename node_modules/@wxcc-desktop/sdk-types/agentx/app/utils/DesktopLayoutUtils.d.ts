...
export declare type LayoutUserRoles = "agent" | "supervisor" | "supervisorAgent";
...
export declare const getLayoutConfigFromCache: () => Store.Dynamic.CachedLayout | undefined;
export declare const getLayoutFromAPIGateway: (attributes: Service.Cms.DesktopLayoutResponse | undefined) => [Store.Dynamic.ConfigJson | undefined, Store.Dynamic.DesktopLayoutJson | Store.Dynamic.ConfigJson] | undefined;
...
export declare const fetchLocalDesktopLayout: () => Promise<[Store.Dynamic.ConfigJson | undefined, Store.Dynamic.DesktopLayoutJson | Store.Dynamic.ConfigJson]>;
...
export { processJSONLayout, processCachedLayoutJson };
