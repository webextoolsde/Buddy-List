...
export declare const wasApplied: (mixin: AnyFunction<any>, superClass: AnyConstructor<HTMLElement>) => boolean;
export declare const DedupeMixin: (mixin: AnyFunction<any>, superClass: AnyConstructor<HTMLElement>) => void;
